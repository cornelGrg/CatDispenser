...
void EnablePowerSaving() {
    ...
    esp_wifi_set_ps(WIFI_PS_MIN_MODEM);  //minimum power save mode for Wi-Fi
    esp_wifi_set_max_tx_power(20);  //lower maximum transmission power
...
void DisablePowerSaving() {
    ...
    esp_wifi_set_max_tx_power(78);  //restore default maximum transmission power
